...
const PesosCuerpoScreen = () => {
    ...
    const onSave = async () => {
        try {
            ...
            if (response.ok) {
                Alert.alert('Registro guardado con éxito.', { job });
                navigation.navigate('Pesos');
            setData({
                    item: '',
                    operador: '',
                    ensamble: '',
    ...
    return (
           <ImageBackground source={require('../assets/bg1-eb.jpg')} style={{ flex: 1 }}>
               ...
               <View style={styles.headerBox}>
                   <Text style={styles.headerText}>Registro de Pesos y Espumado: ᴄᴜᴇʀᴘᴏ</Text>
               </View>
...
export default PesosCuerpoScreen;
